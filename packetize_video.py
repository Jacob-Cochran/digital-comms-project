...
class packetize_video(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "packetize_video")
...
def main(top_block_cls=packetize_video, options=None):
