...
class packetized_loopback_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_2_0_0_0_0 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
        ...
        self.qtgui_time_sink_x_0_2_0_0_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_2_0_0_0_0.set_y_axis(-0.1, 1.1)

        self.qtgui_time_sink_x_0_2_0_0_0_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_2_0_0_0_0.enable_tags(True)
        self.qtgui_time_sink_x_0_2_0_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.2, 0.0, 0, "packet_len")
        self.qtgui_time_sink_x_0_2_0_0_0_0.enable_autoscale(False)
        self.qtgui_time_sink_x_0_2_0_0_0_0.enable_grid(False)
        self.qtgui_time_sink_x_0_2_0_0_0_0.enable_axis_labels(True)
        self.qtgui_time_sink_x_0_2_0_0_0_0.enable_control_panel(False)
        self.qtgui_time_sink_x_0_2_0_0_0_0.enable_stem_plot(False)
        ...
        for i in range(4):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_label(i, labels[i])
            self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_width(i, widths[i])
            self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_color(i, colors[i])
            self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_style(i, styles[i])
            self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_marker(i, markers[i])
            self.qtgui_time_sink_x_0_2_0_0_0_0.set_line_alpha(i, alphas[i])

        self._qtgui_time_sink_x_0_2_0_0_0_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0_2_0_0_0_0.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_time_sink_x_0_2_0_0_0_0_win)
        self.qtgui_time_sink_x_0_2_0_0_0 = qtgui.time_sink_f(
            256, #size
            samp_rate, #samp_rate
        ...
        self.qtgui_time_sink_x_0_2_0_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_2_0_0_0.set_y_axis(-0.1, 1.1)

        self.qtgui_time_sink_x_0_2_0_0_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_2_0_0_0.enable_tags(True)
        self.qtgui_time_sink_x_0_2_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.2, 0.0, 0, "packet_len")
        self.qtgui_time_sink_x_0_2_0_0_0.enable_autoscale(False)
        self.qtgui_time_sink_x_0_2_0_0_0.enable_grid(False)
        self.qtgui_time_sink_x_0_2_0_0_0.enable_axis_labels(True)
        self.qtgui_time_sink_x_0_2_0_0_0.enable_control_panel(False)
        self.qtgui_time_sink_x_0_2_0_0_0.enable_stem_plot(False)
        ...
        for i in range(4):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_0_2_0_0_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_sink_x_0_2_0_0_0.set_line_label(i, labels[i])
            self.qtgui_time_sink_x_0_2_0_0_0.set_line_width(i, widths[i])
            self.qtgui_time_sink_x_0_2_0_0_0.set_line_color(i, colors[i])
            self.qtgui_time_sink_x_0_2_0_0_0.set_line_style(i, styles[i])
            self.qtgui_time_sink_x_0_2_0_0_0.set_line_marker(i, markers[i])
            self.qtgui_time_sink_x_0_2_0_0_0.set_line_alpha(i, alphas[i])

        self._qtgui_time_sink_x_0_2_0_0_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0_2_0_0_0.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_time_sink_x_0_2_0_0_0_win)
        self.qtgui_time_sink_x_0_1_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "RX Time Domain After Costas", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_0_win, 31, 1, 1, 1)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_time_raster_sink_x_1_0_2 = qtgui.time_raster_sink_b(
            samp_rate,
            64,
            out_frame_sync_cols,
            [],
        ...
        self.qtgui_time_raster_sink_x_1_0_2.set_update_time(0.10)
        self.qtgui_time_raster_sink_x_1_0_2.set_intensity_range(0, 1)
        self.qtgui_time_raster_sink_x_1_0_2.enable_grid(False)
        self.qtgui_time_raster_sink_x_1_0_2.enable_axis_labels(True)
        self.qtgui_time_raster_sink_x_1_0_2.set_x_label("")
        self.qtgui_time_raster_sink_x_1_0_2.set_x_range(0.0, 0.0)
        self.qtgui_time_raster_sink_x_1_0_2.set_y_label("")
        self.qtgui_time_raster_sink_x_1_0_2.set_y_range(0.0, 0.0)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_raster_sink_x_1_0_2.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_raster_sink_x_1_0_2.set_line_label(i, labels[i])
            self.qtgui_time_raster_sink_x_1_0_2.set_color_map(i, colors[i])
            self.qtgui_time_raster_sink_x_1_0_2.set_line_alpha(i, alphas[i])

        self._qtgui_time_raster_sink_x_1_0_2_win = sip.wrapinstance(self.qtgui_time_raster_sink_x_1_0_2.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_1_0_2_win, 29, 1, 1, 1)
        for r in range(29, 30):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_time_raster_sink_x_1_0_1 = qtgui.time_raster_sink_b(
            samp_rate,
            64,
            out_frame_sync_cols,
            [],
        ...
        self.qtgui_time_raster_sink_x_1_0_1.set_update_time(0.10)
        self.qtgui_time_raster_sink_x_1_0_1.set_intensity_range(0, 1)
        self.qtgui_time_raster_sink_x_1_0_1.enable_grid(False)
        self.qtgui_time_raster_sink_x_1_0_1.enable_axis_labels(True)
        self.qtgui_time_raster_sink_x_1_0_1.set_x_label("")
        self.qtgui_time_raster_sink_x_1_0_1.set_x_range(0.0, 0.0)
        self.qtgui_time_raster_sink_x_1_0_1.set_y_label("")
        self.qtgui_time_raster_sink_x_1_0_1.set_y_range(0.0, 0.0)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_raster_sink_x_1_0_1.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_raster_sink_x_1_0_1.set_line_label(i, labels[i])
            self.qtgui_time_raster_sink_x_1_0_1.set_color_map(i, colors[i])
            self.qtgui_time_raster_sink_x_1_0_1.set_line_alpha(i, alphas[i])

        self._qtgui_time_raster_sink_x_1_0_1_win = sip.wrapinstance(self.qtgui_time_raster_sink_x_1_0_1.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_1_0_1_win, 30, 1, 1, 1)
        for r in range(30, 31):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_time_raster_sink_x_1_0_0 = qtgui.time_raster_sink_b(
            samp_rate,
            64,
            out_frame_sync_cols,
            [],
        ...
        self.qtgui_time_raster_sink_x_1_0_0.set_update_time(0.10)
        self.qtgui_time_raster_sink_x_1_0_0.set_intensity_range(0, 1)
        self.qtgui_time_raster_sink_x_1_0_0.enable_grid(False)
        self.qtgui_time_raster_sink_x_1_0_0.enable_axis_labels(True)
        self.qtgui_time_raster_sink_x_1_0_0.set_x_label("")
        self.qtgui_time_raster_sink_x_1_0_0.set_x_range(0.0, 0.0)
        self.qtgui_time_raster_sink_x_1_0_0.set_y_label("")
        self.qtgui_time_raster_sink_x_1_0_0.set_y_range(0.0, 0.0)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_raster_sink_x_1_0_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_raster_sink_x_1_0_0.set_line_label(i, labels[i])
            self.qtgui_time_raster_sink_x_1_0_0.set_color_map(i, colors[i])
            self.qtgui_time_raster_sink_x_1_0_0.set_line_alpha(i, alphas[i])

        self._qtgui_time_raster_sink_x_1_0_0_win = sip.wrapinstance(self.qtgui_time_raster_sink_x_1_0_0.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_time_raster_sink_x_1_0_0_win, 30, 0, 1, 1)
        for r in range(30, 31):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_correlate_access_code_xx_ts_0_1 = digital.correlate_access_code_bb_ts(access_key,
          0, "")
        ...
        self.blocks_unpack_k_bits_bb_0_0_0_1_1 = blocks.unpack_k_bits_bb(constellation.bits_per_symbol())
        self.blocks_unpack_k_bits_bb_0_0_0_1_0 = blocks.unpack_k_bits_bb(constellation.bits_per_symbol())
        self.blocks_unpack_k_bits_bb_0_0_0_1 = blocks.unpack_k_bits_bb(constellation.bits_per_symbol())
        self.blocks_unpack_k_bits_bb_0_0_0 = blocks.unpack_k_bits_bb(constellation.bits_per_symbol())
        ...
        self.blocks_repack_bits_bb_1_1 = blocks.repack_bits_bb(8, 1, "", False, gr.GR_MSB_FIRST)
        ...
        self.connect((self.blocks_repack_bits_bb_1_0, 0), (self.digital_correlate_access_code_xx_ts_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_0_1, 0), (self.digital_correlate_access_code_xx_ts_0_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_1, 0), (self.digital_correlate_access_code_xx_ts_0_1, 0))
        self.connect((self.blocks_skiphead_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0_0, 0), (self.digital_crc32_bb_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_unpacked_to_packed_xx_0_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.qtgui_time_raster_sink_x_0_0, 0))
        self.connect((self.blocks_uchar_to_float_0_0, 0), (self.qtgui_time_sink_x_0_2_0_0_0, 3))
        self.connect((self.blocks_uchar_to_float_0_0_0, 0), (self.qtgui_time_sink_x_0_2_0_0_0_0, 3))
        self.connect((self.blocks_uchar_to_float_0_0_0_0, 0), (self.qtgui_time_sink_x_0_2_0_0_0_0, 2))
        self.connect((self.blocks_uchar_to_float_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0_2_0_0_0_0, 0))
        self.connect((self.blocks_uchar_to_float_0_0_0_1, 0), (self.qtgui_time_sink_x_0_2_0_0_0_0, 1))
        self.connect((self.blocks_uchar_to_float_0_0_1, 0), (self.qtgui_time_sink_x_0_2_0_0_0, 2))
        self.connect((self.blocks_uchar_to_float_0_0_1_0, 0), (self.qtgui_time_sink_x_0_2_0_0_0, 0))
        self.connect((self.blocks_uchar_to_float_0_0_2, 0), (self.qtgui_time_sink_x_0_2_0_0_0, 1))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.blocks_repack_bits_bb_1_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.blocks_uchar_to_float_0_0_1_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.qtgui_time_raster_sink_x_1_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1, 0), (self.blocks_repack_bits_bb_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1, 0), (self.blocks_uchar_to_float_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1, 0), (self.qtgui_time_raster_sink_x_1_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1_0, 0), (self.blocks_repack_bits_bb_1_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1_0, 0), (self.blocks_uchar_to_float_0_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1_0, 0), (self.qtgui_time_raster_sink_x_1_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1_1, 0), (self.blocks_repack_bits_bb_1_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1_1, 0), (self.blocks_uchar_to_float_0_0_2, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1_1, 0), (self.qtgui_time_raster_sink_x_1_0_2, 0))
        self.connect((self.blocks_unpacked_to_packed_xx_0_0, 0), (self.digital_constellation_modulator_0_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_1_1, 0))
        self.connect((self.digital_constellation_decoder_cb_0_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_1_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0_0_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_1, 0))
        ...
        self.connect((self.digital_correlate_access_code_xx_ts_0_0, 0), (self.blocks_uchar_to_float_0_0_0_0, 0))
        self.connect((self.digital_correlate_access_code_xx_ts_0_0_0, 0), (self.blocks_uchar_to_float_0_0_0_0_0, 0))
        self.connect((self.digital_correlate_access_code_xx_ts_0_1, 0), (self.blocks_uchar_to_float_0_0_0_1, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0_2_0_0_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_2_0_0_0_0.set_samp_rate(self.samp_rate)
    ...
    def set_out_frame_sync_cols(self, out_frame_sync_cols):
        ...
        self.qtgui_time_raster_sink_x_1_0.set_num_cols(self.out_frame_sync_cols)
        self.qtgui_time_raster_sink_x_1_0_0.set_num_cols(self.out_frame_sync_cols)
        self.qtgui_time_raster_sink_x_1_0_1.set_num_cols(self.out_frame_sync_cols)
        self.qtgui_time_raster_sink_x_1_0_2.set_num_cols(self.out_frame_sync_cols)
