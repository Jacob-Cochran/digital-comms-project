...
class packetized_loopback_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_time_raster_sink_x_0_1_1 = qtgui.time_raster_sink_b(
            samp_rate,
            64,
            out_frame_sync_cols,
            [],
        ...
        self.qtgui_time_raster_sink_x_0_1_1.set_intensity_range(0, 1)
        self.qtgui_time_raster_sink_x_0_1_1.enable_grid(False)
        self.qtgui_time_raster_sink_x_0_1_1.enable_axis_labels(True)
        self.qtgui_time_raster_sink_x_0_1_1.set_x_label("")
        self.qtgui_time_raster_sink_x_0_1_1.set_x_range(0.0, 0.0)
        self.qtgui_time_raster_sink_x_0_1_1.set_y_label("")
        self.qtgui_time_raster_sink_x_0_1_1.set_y_range(0.0, 0.0)
        ...
        self._qtgui_time_raster_sink_x_0_1_1_win = sip.wrapinstance(self.qtgui_time_raster_sink_x_0_1_1.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_time_raster_sink_x_0_1_1_win)
        ...
        self.qtgui_time_raster_sink_x_0_1_0 = qtgui.time_raster_sink_b(
            samp_rate,
            64,
            out_frame_sync_cols,
            [],
        ...
        self.qtgui_time_raster_sink_x_0_1_0.set_intensity_range(0, 1)
        self.qtgui_time_raster_sink_x_0_1_0.enable_grid(False)
        self.qtgui_time_raster_sink_x_0_1_0.enable_axis_labels(True)
        self.qtgui_time_raster_sink_x_0_1_0.set_x_label("")
        self.qtgui_time_raster_sink_x_0_1_0.set_x_range(0.0, 0.0)
        self.qtgui_time_raster_sink_x_0_1_0.set_y_label("")
        self.qtgui_time_raster_sink_x_0_1_0.set_y_range(0.0, 0.0)
        ...
        self._qtgui_time_raster_sink_x_0_1_0_win = sip.wrapinstance(self.qtgui_time_raster_sink_x_0_1_0.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_time_raster_sink_x_0_1_0_win)
        ...
        self.digital_diff_decoder_bb_0_0_0_1 = digital.diff_decoder_bb(constellation.arity(), digital.DIFF_DIFFERENTIAL)
        ...
        self.connect((self.digital_diff_decoder_bb_0_0, 0), (self.blocks_char_to_float_0_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0, 0), (self.blocks_uchar_to_float_0_0_1_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0, 0), (self.digital_correlate_access_code_xx_ts_0_0_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0, 0), (self.qtgui_time_raster_sink_x_0_1_0_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0, 0), (self.blocks_char_to_float_0_0_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0, 0), (self.blocks_uchar_to_float_0_0_2, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0, 0), (self.digital_correlate_access_code_xx_ts_0_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0, 0), (self.qtgui_time_raster_sink_x_0_1_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_0, 0), (self.blocks_char_to_float_0_0_0_0_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_0, 0), (self.blocks_uchar_to_float_0_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_0, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_0, 0), (self.qtgui_time_raster_sink_x_0_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_1, 0), (self.blocks_char_to_float_0_0_0_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_1, 0), (self.blocks_uchar_to_float_0_0_1, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_1, 0), (self.digital_correlate_access_code_xx_ts_0_0, 0))
        self.connect((self.digital_diff_decoder_bb_0_0_0_1, 0), (self.qtgui_time_raster_sink_x_0_1_0, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0_0, 1), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.digital_symbol_sync_xx_0_0, 2), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.digital_symbol_sync_xx_0_0, 3), (self.qtgui_time_sink_x_1_0, 1))
    ...
    def set_out_frame_sync_cols(self, out_frame_sync_cols):
        ...
        self.qtgui_time_raster_sink_x_0_1_0.set_num_cols(self.out_frame_sync_cols)
        self.qtgui_time_raster_sink_x_0_1_0_0.set_num_cols(self.out_frame_sync_cols)
        self.qtgui_time_raster_sink_x_0_1_1.set_num_cols(self.out_frame_sync_cols)
