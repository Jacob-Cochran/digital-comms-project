...
class basic_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "basic_rx")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(20, [16], 0, int(48e3))
        self.audio_sink_0 = audio.sink(int(48e3), 'hw:0,2', True)
...
def main(top_block_cls=basic_rx, options=None):
